...
public class DatabaseQueryMaker {
	...
	public String studentInsertQuery(String userName, int typeId, String password, String nationality, String email, LocalDate dateJoined)
	{
	...
	public String proposedProblemInsertQuery (String name,String task,String solution,int proposerId,int popularity,int difficulty,int grade,String subject)
	{
		StringBuilder problemIQ = new StringBuilder ("INSERT INTO pandemicspecial.problem VALUES (NULL, "+name+","+task+","+solution+",");
	...
	public String studentSolutionInsertQuery (int studentId, int problemId,String studentSolution,int tutorId,int moderatorId,String tutorFeedback,double tutorRating,String moderatorFeedback,double moderatorRating)
	{
		tutorId = 0;
		moderatorId =0;
		tutorFeedback =" ";
